...
// db.run('CREATE TABLE IF NOT EXISTS groups (id INTEGER PRIMARY KEY, name_group TEXT NOT NULL, token_bot TEXT NOT NULL, chat_id TEXT, admins TEXT, status_chat BLOB, status_webhook BLOB)');
